...
export default function AuthLayout({
  ...
  return (
    <div className="grid grid-cols-5 2xl:grid-cols-3 w-full min-h-screen relative">
      <div className="w-full col-span-3 2xl:col-span-2 p-5 h-full flex flex-col gap-10 justify-center items-center relative bg-brandGray">
